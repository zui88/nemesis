...
-- awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒", "➓" }
--wful.util.tagnames = { " DEV ", " WWW ", " SYS ", " DOC ", " VBOX ", " CHAT ", " MUS ", " VID ", " GFX " }
-- awful.util.tagnames = { "⠐", "⠡", "⠌", "⠲","⠖", "⠵", "⠮", "⠻", "⠟", "⠿" }
awful.util.tagnames = { "♚", "♜", "☢", "☣","⌥", "⠵", "⠮", "⠻", "⠟", "⠿" }
...
globalkeys = my_table.join(
 ...
 awful.key({ modkey }, "d", function () awful.util.spawn( "rofi -show drun" ) end,
  ...
  -- My Programms
  -- Shift + Ctrl
   awful.key({ modkey, "Shift"   }, "b", function() awful.util.spawn( "thunar" ) end,
    {description = "Thunar File Browser", group = "Shift + Ctrl"}),
  awful.key({ modkey, "Shift"   }, "q", function() awful.util.spawn( browser2 ) end,
    {description = "Qute Browser", group = "Shift + Ctrl"}),
awful.key({ modkey, "Shift"   }, "o", function() awful.util.spawn( "olivia" ) end,
    {description = "Olivia Player", group = "Shift + Ctrl"}),
  awful.key({ modkey, "Shift"   }, "s", function() awful.util.spawn( mediaplayer ) end,
    {description = "Spotify", group = "Shift + Ctrl"}),
  awful.key({ modkey, "Shift" }, "a", function() awful.util.spawn( "anki" ) end,
    {description = "Anki", group = "Shift + Ctrl"}),
  awful.key({ modkey, "Shift" }, "w", function () awful.util.spawn( browser1 ) end,
    {description = "Brave Browser", group = "Shift + Ctrl"}),
  awful.key({ modkey, "Shift" }, "e", function () awful.util.spawn( editorgui ) end,
    {description = "Emacs", group = "Shift + Ctrl"}),
  awful.key({ modkey, "Shift"   }, "i", function() awful.util.spawn("nitrogen") end,
    {description = nitrogen, group = "alt+ctrl"}),
  awful.key({ modkey1, "Shift"   }, "l", function() awful.util.spawn( "arcolinux-logout" ) end,
    {description = scrlocker, group = "alt+ctrl"}),
  awful.key({ modkey1, "Shift"   }, "o", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/picom-toggle.sh") end,
    {description = "Picom toggle", group = "alt+ctrl"}),
  awful.key({ modkey1, "Shift"   }, "Return", function() awful.util.spawn(terminal) end,
    {description = terminal, group = "alt+ctrl"}),
  awful.key({ modkey1, "Shift"   }, "m", function() awful.util.spawn( "xfce4-settings-manager" ) end,
  ...
  --   {description = "focus the previous screen", group = "layout"}),
 awful.key({ modkey, "Shift"   }, "h",     function () awful.tag.incmwfact( 0.05)          end,
    {description = "increase/decrease master width", group = "layout"}),
 ...
 -- awful.key({ modkey, "Shift"   }, "h",     function () awful.tag.incnmaster( 1, nil, true) end,
  --   {description = "reorder layout", group = "layout"}),
  -- awful.key({ modkey, "Shift"   }, "l",     function () awful.tag.incnmaster(-1, nil, true) end,
  --   {description = "reorder layout", group = "layout"}),
  -- awful.key({ modkey, "Shift" }, "j",     function () awful.tag.incncol( 1, nil, true)    end,
  --   {description = "reorder slave stack", group = "layout"}),
  -- awful.key({ modkey, "Shift" }, "k",     function () awful.tag.incncol(-1, nil, true)    end,
  --   {description = "reorder slave stack", group = "layout"}),
