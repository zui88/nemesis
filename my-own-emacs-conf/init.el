...
;;                                                 nil)))
;;(add-hook 'term-mode-hook (lambda () (ace-window-display-mode 1)))
...
(defun my/return ()
  ...
  (move-end-of-line 1)
  (newline-and-indent))
(global-set-key (kbd "C-<return>") 'my/return)
...
(custom-set-variables
 ...
 '(org-agenda-files "~/study/schedule.org")
 '(org-mode-hook
   '(er/add-org-mode-expansions org-pdftools-setup-link org-tempo-setup
				(lambda nil
 ...
 '(package-selected-packages
   '(ace-window org-tempo company-c-headers flycheck-clang-analyzer yasnippet-snippets yasnippet flycheck lsp-ui lsp-ivy lsp-mode org-pdftools org-pdfview pdf-tools magit projectile ranger company-irony symon dmenu diminish dashboard sudo-edit switch-window beacon which-key linum-relative org-superstar spaceline async ido-vertical-mode doom-themes hungry-delete expand-region rainbow-delimiters company use-package ivy-rich counsel avy))
 '(term-mode-hook '((lambda nil (ace-window-display-mode 1)))))
(custom-set-faces
