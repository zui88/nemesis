    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#343434"),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), color[2]),
            -- arrow("#497B96", "#777E76"),
            arrow(color[2], color[1]),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), color[1]),
            -- arrow("#777E76", "#4B696D"),
            arrow(color[1], color[2]),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), color[2]),
            -- arrow("#4B696D", "#4B3B51"),
            arrow(color[2], color[1]),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), color[1]),
            -- arrow("#4B3B51", "#CB755B"),
            arrow(color[1], color[2]),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), color[2]),
            -- arrow("#CB755B", "#8DAA9A"),
            arrow(color[2], color[1]),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), color[1]),
            -- arrow("#8DAA9A", "#C0C0A2"),
            arrow(color[1], color[2]),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), color[2]),
            -- arrow("#C0C0A2", "#777E76"),
            arrow(color[2], color[1]),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), color[1]),
            -- arrow("#777E76", "alpha"),
            arrow(color[1], "alpha"),
            --]]
            s.mylayoutbox,
